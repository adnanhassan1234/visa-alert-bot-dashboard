...
export default function Home() {
  ...
  // jab component mount hoga to localStorage check karega
  useEffect(() => {
    const storedToken = localStorage.getItem("knm_token");
    setToken(storedToken);
  }, []);

  //   const [token, setToken] = useState<string | null>(() => {
  //   if (typeof window === "undefined") return null;
  //   return localStorage.getItem("knm_token");
  //   // optionally: try/catch if needed
  // });

  // // (OPTIONAL) agar kisi aur tab se logout/login ho to sync raho
  // useEffect(() => {
  //   const onStorage = (e: StorageEvent) => {
  //     if (e.key === "knm_token") setToken(e.newValue);
  //   };
        ...
        return (
          <div className="website-section">
            ...
            <div className="alert-item alert-info">
              This page is under development. All functionality from the
              original HTML has been preserved and will be implemented in future
              updates.
            </div>
          </div>
        );
        ...
        <>
          ...
          <div
            className={`main-content ${
              !sidebarVisible ? "expandeds" : "expanded"
            }`}
          >
            <TopBar
